      ...
      <div style={{ padding: 10 }}>
        ...
        >
          ...
          <Form inline={false} field={this.field}>
            <FormItem label={locale.configId} required {...formItemLayout}>
              <Input htmlType={'text'} readOnly {...init('dataId')} />
            </FormItem>
            <FormItem label={locale.applicationGroup} required {...formItemLayout}>
              <Input htmlType={'text'} readOnly {...init('group')} />
            </FormItem>
						<div>
							<FormItem label={locale.home} required {...formItemLayout}>
