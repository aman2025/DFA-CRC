    ...
    return (
      <div style={{ padding: 10 }}>
        ...
        <Form field={this.field}>
          <FormItem label={locale.configId} {...formItemLayout}>
            <Input htmlType="text" readOnly {...init('dataId')} />
          </FormItem>
          <div>
            <FormItem label={locale.applicationGroup} {...formItemLayout}>
          ...
          <FormItem label={locale.actionType} {...formItemLayout}>
            <Input htmlType="text" readOnly {...init('opType')} />
          </FormItem>
          <FormItem label={locale.configuration} {...formItemLayout}>
