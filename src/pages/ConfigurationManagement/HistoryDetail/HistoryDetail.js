    ...
    return (
      <div style={{ padding: 10 }}>
        ...
        <Form field={this.field}>
          <Form.Item label={locale.configId} {...formItemLayout}>
            <Input htmlType="text" readOnly {...init('dataId')} />
          </Form.Item>
          <div>
            <Form.Item label={locale.applicationGroup} {...formItemLayout}>
          ...
          <Form.Item label={locale.actionType} {...formItemLayout}>
            <Input htmlType="text" readOnly {...init('opType')} />
          </Form.Item>
          <Form.Item label={locale.configureContent} {...formItemLayout}>
