...
const I18N_CONF = {
  ...
  ServiceList: {
    ...
    groupNamePlaceholder: 'Enter Application Name',
  ...
  ListeningToQuery: {
    ...
    pleaseEnterTheDataId: 'Enter Config ID',
    dataIdCanNotBeEmpty: 'Config ID cannot be empty',
    pleaseInputGroup: 'Enter Application',
    groupCanNotBeEmpty: 'Application cannot be empty',
  ...
  HistoryRollback: {
    ...
    dataId: 'Enter Config ID',
    dataIdCanNotBeEmpty: 'Config ID cannot be empty',
    group: 'Enter Application',
    groupCanNotBeEmpty: 'Application cannot be empty',
    query: 'Search',
  ...
  ConfigurationManagement: {
    ...
    fuzzyd: 'Enter Config ID Include *',
    fuzzyg: 'Enter Application Include *',
    query: 'Search',
  ...
  NewConfig: {
    ...
    newConfig: 'Config ID cannot be empty.',
    dataIdIsNotEmpty: 'Config ID cannot exceed 255 characters in length',
    groupPlaceholder: 'Enter your group name',
    moreAdvanced: 'Application cannot be empty',
    groupNotEmpty: 'Application ID cannot exceed 127 characters in length',
    annotation:
  ...
  ConfigEditor: {
    ...
    recipientFrom: 'Config ID cannot be empty',
    homeApplication: 'Application name cannot be empty',
    collapse: 'Collapse',
  ...
  NewRole: {
    ...
    bindUserToRoleFailDefault: 'role already exist!',
