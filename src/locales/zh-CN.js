...
const I18N_CONF = {
  ...
  ListeningToQuery: {
    ...
    listenerQuery: '监听查询',
    queryDimension: '查询维度',
    pleaseEnterTheDataId: '请输入配置ID',
    dataIdCanNotBeEmpty: '配置ID不能为空',
    pleaseInputGroup: '请输入应用',
    groupCanNotBeEmpty: '应用不能为空',
    pleaseInputIp: '请输入IP',
    query: '查询',
    queryResultsQuery: '查询结果共查询到',
  ...
  NewConfig: {
    ...
    doNotEnter: '不允许非法字符',
    newConfig: '配置ID 不能为空',
    dataIdIsNotEmpty: '配置ID 长度不能超过255字符',
    groupPlaceholder: '请输入应用英文简称，建议：字母大写，名称较长时使用点(.)分隔。',
    moreAdvanced: '应用不能为空',
    groupNotEmpty: '应用简称长度不能超过127字符',
    annotation:
    ...
    dataIdExists: '配置已存在, 试试别的配置id和应用简称的组合',
  ...
  ConfigEditor: {
    ...
    vdchart: '请勿输入非法字符',
    recipientFrom: '配置ID不能为空',
    homeApplication: '应用不能为空',
    collapse: '收起',
    groupNotEmpty: '更多高级选项',
    tags: '标签',
    pleaseEnterTag: '请输入标签',
    targetEnvironment: '应用中文名称',
    description: '描述',
    format: '配置格式',
    configcontent: '配置内容',
    escExit: '按F1显示全屏',
  ...
  NewNameSpace: {
    ...
    name: '命名空间名',
    namespaceId: '命名空间ID',
    namespaceIdTooLong: '命名空间ID长度不能超过36',
    namespaceTooLong: '命名空间长度不能超过36',
  ...
  NewUser: {
    ...
    userAlreadyExists: '创建的用户已存在!',
    userSuccessed: '用户创建成功!',
  },
  PasswordReset: {
    resetPassword: '密码重置',
    username: '用户名',
  ...
  NewRole: {
    ...
    usernameError: '用户名不能为空！',
    roleError: '角色名不能为空!',
    bindUserToRoleFailDefault: '用户绑定到角色的信息已存在!',
